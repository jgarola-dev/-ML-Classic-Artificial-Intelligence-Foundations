...
if st.sidebar.button("🌐 Cargar Dataset UCI Oficial"):
    with st.spinner("Descargando y procesando..."):
        try:
            ...
            # Asegurar columna binaria 'Abandono'
...
if page == "🏠 Inicio":
    ...
    if not st.session_state.prep:
        ...
        with c1:
            ...
            horas = st.slider("⏱️ Horas de Estudio (semanales)", 0, 20, 3)
        with c2:
        ...
        if st.button("🔮 Realizar Predicción", type="primary"):
            try:
                pred_dict = {'edad': edad, 'gpa': gpa, 'asistencia': assist, 'horas_estudio': horas,
